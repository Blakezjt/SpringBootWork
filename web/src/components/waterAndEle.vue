<template>
    ...
    <el-table :data="tableList" stripe style="width: 100%">
      ...
      <el-table-column prop="dorm" label="宿舍号" />
      <el-table-column prop="serviceCondition" label="水电详情" />
      <el-table-column prop="amount" label="水电总费用" />
  ...
  import { findAllWaterAndEleByPages } from '../api/waterAndELe.js'
  ...
  const AllRepairByPages = () => {
    let result = findAllWaterAndEleByPages(currentPage4.value, pageSize4.value);
